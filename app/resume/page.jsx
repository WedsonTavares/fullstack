...
const about = {
    ...
    info: [
        ...
        {
            title: "Linkedin:",
            value: "https://www.linkedin.com/in/wedsontavares/"
        },
        {
            title: "Nacionalidade:",
            value: "Brasil"
...
const education = {
    icon: "foto de icone",
    title: "Meus Cursos",
    description: "Curos feitos ao longo da minha carreira",
    items: [
        {
            ...
            <div className="container mx-auto">
                <Tabs
                    ...
                    <TabsList className="flex flex-col w-full max-w-[380px] mx-auto gap-6 xl:mx-0">
                        ...
                        <TabsTrigger value="about"> Sobre min</TabsTrigger>
                    </TabsList>
                    {/* Conteúdo */}
                    <div className="min-h-[70vh] w-full">
                        ...
                        <TabsContent value="experience" className="w-full">
                            <div className="flex flex-col gap-[30px] text-center xl:text-left">
                                ...
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px] rounded-lg">
                        ...
                        <TabsContent value="skills" className="w-full h-full">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 xs:gap-[30px]">
                        ...
                        <TabsContent value="about" className="w-full text-center xl:text-left">
                            <div className="flex flex-col gap-[30px]">
                                <h3 className="text-4xl font-bold">{about.mTitle}</h3>
